...
void SampleSource::FillDataBase() {
    ...
    Movie *m =
        new Movie(HORROR, HINDI, 2018, "Stree", "Rajkummar Rao", "Shraddha Kapoor", "Amar Kaushik",
                  "Rajkummar Rao, Shraddha Kapoor, Pankaj Tripathi, Aparshakti Khurana");
    m_dbMgr->insertMovieData(m);

    Movie *m1 = new Movie(BIOGRAPY, HINDI, 2019, "Gully Boy", "Ranveer Singh", "Alia Bhatt",
                          "Zoya Akhtar", "Ranveer Singh, Alia Bhatt, Siddhant Chaturvedi");
    m_dbMgr->insertMovieData(m1);

    Movie *m2 = new Movie(BIOGRAPY, HINDI, 2019, "Uri: The Surgical Strike", "Vicky Kaushal",
